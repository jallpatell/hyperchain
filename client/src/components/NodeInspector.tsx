                            ...
                            {formData.provider === 'gmail-oauth' && (
                                <div className="space-y-2">
                                    ...
                                    {showGmailNotice && (
                                        <Alert className="mt-2 bg-blue-50 border-blue-200">
                                            ...
                                            <AlertDescription className="text-blue-800">
                                                You're being redirected to Google for authentication. Please authorize
                                                the app to send emails on your behalf. You'll be returned here once
                                                complete.
                                            </AlertDescription>
                                        </Alert>
                                    )}
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(val) => handleChange('credentialId', parseInt(val))}
                                    >
                                        <SelectTrigger>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Select a Gmail account connected in Credentials. Go to the Credentials page to
                                        add more.
                                    </p>
                                </div>
                            )}
                        ...
                        {confirmOpen && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
                                <div className="bg-background border rounded-xl shadow-xl p-6 w-[350px] animate-in fade-in zoom-in-95">
                                    <h3 className="text-lg font-semibold mb-2">Delete Current Node!</h3>
                                    <p className="text-sm text-muted-foreground mb-6">
                                        <span className="font-mono text-red-600">WARNING:</span> This action cannot be
                                        undone and may affect downstream nodes. Are you sure you want to proceed?
                                    </p>
