...
export function useExecutionMonitor(executionId: number | null): ExecutionState {
    ...
    useEffect(() => {
        ...
        const connect = () => {
            try {
                ...
                const message = err instanceof Error ? err.message : 'Failed to connect to execution stream';
                setState((prev) => ({
                    ...prev,
                    isConnected: false,
                    error: message,
