                                ...
                                {type === 'gmail-oauth' ? (
                                    <div className="space-y-3">
                                        <Alert>
                                            ...
                                            <AlertDescription>
                                                Click below to connect your Gmail account. You'll be redirected to
                                                Google OAuth.
                                            </AlertDescription>
                                        </Alert>
                                        <Button
                ...
                {showGmailNotice && (
                    <Alert className="mb-6 bg-blue-50 border-blue-200">
                        ...
                        <AlertDescription className="text-blue-800">
                            You're being redirected to Google for authentication. Please authorize the app to send
                            emails on your behalf. You'll be returned here once complete.
                        </AlertDescription>
                    </Alert>
                )}
                                  ...
                                  <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
                                      <div className="flex items-center gap-3">
                                          <div className="p-2 bg-muted rounded-lg">
                                              {cred.type === 'gmail-oauth' ? (
                                                  <Mail className="w-5 h-5 text-red-500" />
                                              ) : cred.type === 'gmail-oauth-config' ? (
